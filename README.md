...
| <a name="input_service_connect_name"></a> [service\_connect\_name](#input\_service\_connect\_name) | n/a | `string` | `null` | no |
...
| <a name="input_service_protocol"></a> [service\_protocol](#input\_service\_protocol) | n/a | `string` | `null` | no |
...
| <a name="input_use_service_connect"></a> [use\_service\_connect](#input\_use\_service\_connect) | n/a | `bool` | `false` | no |
